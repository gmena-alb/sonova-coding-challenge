  ...
  return (
    <HeaderWrapper>
      <div className="top-bar">
        <img src={logo} alt="Geers logo" />
        <div className="contact-info">
          <h4 className="phone-number">030 1234 5678</h4>
      ...
      <div className="banner">
        {!isTablet && (
          <img className="header-image" src={headerMobile} alt="Happy woman" />
        )}
        <div className="intro-container">
          <h3>
            QUIS COMMODO ODIO AENEAN SED ADIPISCING DIAM DONECT ADIPISCING
          </h3>
          ...
          <div className="certs">
            <img
              src={trustCert}
              alt="1. Platz Kundenzufriedenheit"
              width="94"
              height="47"
            />
            <img
              src={trustLogo}
              alt="Kundenauszeichnung eKomi"
              width="45"
              height="45"
            />
